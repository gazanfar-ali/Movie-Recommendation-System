...
# Sample datasets — use the same data as in 1_data_exploration.ipynb
...
# For demonstration, fill any missing values in text columns with empty strings
text_columns = ['genres', 'keywords', 'cast', 'overview']
for col in text_columns:
    movies[col] = movies[col].fillna('')

# Combine genres, keywords, cast into a single 'combined_features' column
...
# (Optional) Save processed dataset for modeling
